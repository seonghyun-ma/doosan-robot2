        ...
        try:
            ...
            if result == None:
                ...
                for i in range(POINT_COUNT):
                    ...
                    # return conv_posx, sol # 이 부분에서 tab을 하나 뺌
...
def align_axis(*args, **kargs):
    ...
    norm_pos = _pos # norm_pos = get_posx(_pos)
    ...
    if _nType == 2: # with ref
        ...
        if __ROS2__:
            ...
            req.x2       = [float(x) for x in _x2]
            req.x3       = [float(x) for x in _x3]
            req.source_vect = [float(x) for x in norm_pos] # pos
            req.axis     = _axis
            req.ref      = _ref
        ...
        if __ROS2__:
            ...
            req.target_vect     = [float(x) for x in _vect] # vect
            req.source_vect      = [float(x) for x in norm_pos] # pos
            req.axis     = _axis
            req.ref      = _ref
